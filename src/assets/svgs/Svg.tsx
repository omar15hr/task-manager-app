...
export function CancelSvg({ size }: SvgProps) {
  return (
    <svg
...
export function BaselineSvg({ size }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CirclePlusSvg({ size }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function ClipboardSvg({ size }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="icon icon-tabler icons-tabler-filled icon-tabler-clipboard"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function PlusSvg({ size }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function CheckSvg({ size }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
